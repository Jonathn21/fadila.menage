...
from .models import Demande,Stagiaire,Entretien,Notification,RapportStage,ConventionStage,Etablissement,StageEffectue,AttestationStage,Diplome
...
admin.site.register(RapportStage)
