...
# ⚠️ CORRECTION : ALLOWED_HOSTS avec Cloudflare
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '0.0.0.0',
...
if os.environ.get('DJANGO_ALLOWED_HOSTS'):
    ...
    for host in env_hosts:
        ...
        if host and host not in ALLOWED_HOSTS:
            # Accepter tous les sous-domaines trycloudflare.com
            if '.trycloudflare.com' in host:
                ALLOWED_HOSTS.append(host)

CSRF_TRUSTED_ORIGINS = os.environ.get(
    "CSRF_TRUSTED_ORIGINS",
    "http://localhost:8080,http://127.0.0.1:8080,http://127.0.0.1:8000,https://gestion-stageemploi.pages.dev"
).split(",")
...
# GEMINI
# ======================
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AIzaSyCssh-ogG_y5iAkoqaIBwl57ApCWB7SrUU")
...
# WEBSOCKET
# ======================
# Accepter les connexions WebSocket via le proxy Cloudflare
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
...
# Headers pour WebSocket via proxy
ASGI_THREADS = 4