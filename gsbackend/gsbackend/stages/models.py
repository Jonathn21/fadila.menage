...
class Stagiaire(models.Model):
    ...
    def get_documents(self):
        ...
        try:
            ...
            try:
                if hasattr(self, 'conventionstage') and self.conventionstage and self.conventionstage.fichier:
                    if self.est_renouvellement:
                        ...
                        nom_convention = "Convention de stage"
            ...
            # Convention de renouvellement temporaire
            if self.convention_renouvellement_temporaire and self.convention_renouvellement_temporaire.fichier:
                documents.append({
            ...
            logger.error(f"Erreur générale dans get_documents pour stagiaire {self.id}: {e}")
