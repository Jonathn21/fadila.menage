        ...
        try:
            with transaction.atomic():
                ...
                convention_definitive = ConventionStage.objects.create(
                    ...
                    # ✅ Retiré : numero_convention=f"RENEW-FINAL-..."
                    # save() appellera generate_numero_renouvellement() automatiquement
                )
    ...
    def post(self, request, stagiaire_id):
        try:
            with transaction.atomic():
                ...
                stagiaire.donnees_pre_renouvellement = None   # ✅ bon nom
                stagiaire.date_pre_renouvellement = None
                stagiaire.pre_renouvellement_en_cours = False

                stagiaire.save(update_fields=[
                    'statut_renouvellement',
                    'donnees_pre_renouvellement',  # ✅ bon nom
                    'date_pre_renouvellement',
                    'pre_renouvellement_en_cours'
                ])
